...
int wait_time_teacher(int burst_teacher[],int rburst_faculty[], int f1, int wait_faculty[], int quant_data, 
  ...
  while(ft<quantum && teaching_assistant==false)
    {
    for (i=0;i<f1;i++)
    {  
...
void waiting( int s1,int f1, int burst_student[],int burst_faculty[],int quant_data, int wait_student[],int wait_faculty[], int quantum)
{
  printf("\n\n|");
